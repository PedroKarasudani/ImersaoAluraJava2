...
public class GeradorDeFigurinhas {
    ...
    public void cria(InputStream inputStream, String nomeArquivo, String textFig) throws Exception{
        //leitura da imagem
        ...
        //configurar font
        Font fonte = new Font(Font.SANS_SERIF, Font.BOLD, 65);
        graphics.setColor(Color.PINK);
        graphics.setFont(fonte);
        
        //escrever uma frase na nova imagem
        graphics.drawString(textFig, 80, novaAltura - 110);
